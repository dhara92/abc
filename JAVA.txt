...
String m = "Hello world!"; String n = m.substring(6,12) + m.substring(12,6); System.out.println(n);
Ans:

How do you write a foreeach loop that will iterate over ArrayListpencilCase? 
Ans: for(Pencil pencil = pencilCase){}
